...
// .wrangler/tmp/bundle-CtVLbS/checked-fetch.js
...
var TelegramBot = class extends BotModel {
  constructor(config) {
    super(config);
  }
...
var worker = {
  async fetch(req, env) {
    ...
    const commands = {
      start: async (bot2, req2, args) => await bot2.start(req2, args),
      help: async (bot2, req2, args) => await bot2.help(req2, args),
      debt: async (bot2, req2, args) => await bot2.debt(req2, args)
    };
    const botConfig = {
...
// .wrangler/tmp/bundle-CtVLbS/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-CtVLbS/middleware-loader.entry.ts
