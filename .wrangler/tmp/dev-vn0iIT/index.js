// .wrangler/tmp/bundle-kRitPb/checked-fetch.js
...
var BotModel = class {
  ...
  async sendMessage(text, chatId, message_thread_id, inlineKeyboard, parseMode = "HTML") {
  ...
  async sendMediaGroup(photoUrls, chatId, caption = "", message_thread_id, parseMode = "HTML") {
  ...
  async sendSticker(stickerId, chatId, message_thread_id, replyMarkup) {
  ...
  async sendPhoto(photoUrls, chatId, caption = "", message_thread_id, inlineKeyboard, parseMode = "HTML") {
...
C\u1EADu c\xF3 th\u1EC3 th\xEAm tu\u1EF3 bi\u1EBFn d\u1EF1a v\xE0o nhu c\u1EA7u hi\u1EC7n t\u1EA1i nh\xE9 \u{1F92D}`, this.message.message_thread_id);
      } else {
...
C\u1EADu c\xF3 th\u1EC3 th\xEAm tu\u1EF3 bi\u1EBFn d\u1EF1a v\xE0o nhu c\u1EA7u hi\u1EC7n t\u1EA1i nh\xE9 \u{1F92D}`, this.message.message_thread_id);
      ...
      await this.sendSticker("CAACAgIAAxkBAAEot_VlmvKyl62IGNoRf6p64AqordsrkAACyD8AAuCjggeYudaMoCc1bzQE", this.message.chat.id, this.message.message_thread_id);
      return await this.sendMessage("C\u1EADu \u0111\xE3 \u0111\u01B0\u1EE3c g\u1EE3i \xFD ro\xE0i, t\u1EDB hong g\u1EE3i \xFD th\xEAm m\xF3n n\u1EEFa \u0111auuu", this.message.chat.id, this.message.message_thread_id);
    }
  }
...
// .wrangler/tmp/bundle-kRitPb/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-kRitPb/middleware-loader.entry.ts
