// .wrangler/tmp/bundle-TLEr7I/checked-fetch.js
...
var BotModel = class {
  ...
  async sendMediaGroup(photoUrls, chatId, caption = "", inlineKeyboard = void 0, parseMode = "HTML") {
...
var randomfoodBot = class extends BotModel {
  ...
  async randomfood(req, args) {
    ...
    console.log(await this.sendMediaGroup([
    ...
    ], this.message.chat.id, "okbro", inline_keyboard));
  }
  async debt(req, args) {
    const text = "hiiii";
    await this.sendMessage(text, this.message.chat.id);
...
// .wrangler/tmp/bundle-TLEr7I/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-TLEr7I/middleware-loader.entry.ts
