// .wrangler/tmp/bundle-k2u3ow/checked-fetch.js
...
var BotModel = class {
  ...
  async sendMessage(text, chatId, inlineKeyboard = void 0, parseMode = "HTML") {
    ...
    const body = {
      ...
      reply_markup: inlineKeyboard ? { inline_keyboard: inlineKeyboard } : void 0
    };
    try {
  ...
  async sendPhoto(photoUrl, chatId, inlineKeyboard = void 0, caption = "", parseMode = "HTML") {
...
var randomfoodBot = class extends BotModel {
  ...
  async randomfood(req, args) {
    ...
    const inline_keyboard = [[{ text: "okiii \u2764\uFE0F", callback_data: "hiem" }]];
    await this.sendMessage(text, this.message.chat.id, inline_keyboard);
    await this.sendPhoto("https://assets-global.website-files.com/6030eb20edb267a2d11d31f6/6333fc293b605c2366de60e4_TelegramLinkCoverImage_fd534fc09bd64f9ffe1770aad70e6dd5_2000.png", this.message.chat.id, inline_keyboard, "okbro");
  }
  async debt(req, args) {
    const text = "hiiii";
    await this.sendMessage(text, this.message.chat.id);
...
function createSession(authCookie) {
  return async function sessionFetch(url, init) {
...
var getImages = async (session, prompt) => {
...
var generateImagesLinks = async (prompt) => {
  const authCookie = "1c197CMFa7WgYwwgbvQzgWZOEjITNyHA9FzGKByEgO9gMYtHpOWWQho1xzzE5gsvOfUAbEuVCRbjROeWhqB9OjjujqaSu9lhdo7R2oVFXKlN0PzEG7cVWw2R1YGXxtJgA_JTdCB3TUu_6hyRRFreTYU0EjgT9FOa91v9apqsQCbbR9WvnlFoWtksbyq-QnYhGn95BN-DKjLBR-0fC9D_fGw";
...
var worker = {
  async fetch(req, env) {
    ...
    console.log(await generateImagesLinks("a pc"));
...
// .wrangler/tmp/bundle-k2u3ow/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-k2u3ow/middleware-loader.entry.ts
