...
// .wrangler/tmp/bundle-BRsjPa/checked-fetch.js
...
var MongoDB = class {
  constructor(REALM_APPID, API_MONGO_TOKEN) {
    this.API_MONGO_TOKEN = API_MONGO_TOKEN;
    this.App = new App(REALM_APPID);
    this.authenticate();
  }
  async authenticate() {
    try {
      const credentials = Credentials.apiKey(this.API_MONGO_TOKEN);
...
var worker = {
  async fetch(req, env) {
    const initMongo = new MongoDB(env.REALM_APPID, env.API_MONGO_TOKEN);
...
// .wrangler/tmp/bundle-BRsjPa/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-BRsjPa/middleware-loader.entry.ts
